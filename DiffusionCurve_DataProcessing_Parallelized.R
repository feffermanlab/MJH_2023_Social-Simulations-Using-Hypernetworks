...
sim_diffCurveData="Sim-diffCurveData_higherOrderContagion_Weights_GoGvsHyp_StratCompare"
sim_T50="Sim-T50_higherOrderContagion_Weights_GoGvsHyp_StratCompare"
