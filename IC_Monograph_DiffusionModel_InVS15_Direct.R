...
incidMats <- importCSVs(path = "~/scratch/IC_Monograph/InVS15/Incidence_Matrices/")
centralityData <- importCSVs(path = "~/scratch/IC_Monograph/InVS15/Centrality_Data/")
...
sim_details="Sim-details_contagionResults_DirectMetrics_InVS15"
