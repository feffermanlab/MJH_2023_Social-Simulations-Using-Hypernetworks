...
sim_details="Sim-details_higherOrderContagion_groupSizeDependent_Walking_PairVsHyp"
...
seedStrategyNames <- c("highestDegree", "highestBetweenness", "highestsiD", 
                       "highestsiBC", "highestGroupsiD", "highestGroupsiBC")
