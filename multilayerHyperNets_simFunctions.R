...
generate_population <- function(n_families, meanFamilySize, clustering, nInitInformed, clusterByFamily) {
  ...
  ind_data<-data.frame(id, family, domRank, initProduce, produce)
