...
#Create folder in which to store simulation results
run_ID=strftime(Sys.time(), format="d3%Y%m%d%H%M%S")
sim_details_low="saTBCData_lowCorr_May24_2"
sim_details_high="saTBCData_highCorr_May24_2"
...
#lowCorList <- importCSVs(path = "C://Users/matth/Desktop/hyperGraph_Sequences_lowCorr_May24/")
