...
diffDataList <- importCSVs(path = "~/scratch/IC_Monograph/Sim-details_contagionResults_DirectMetrics_July11/")

#Create folder in which to store simulation results
run_ID=strftime(Sys.time(), format="d3%Y%m%d%H%M%S")
sim_diffCurveData="Sim-diffCurveData_DirectMetrics_July11"
sim_T50="Sim-T50_DirectMetrics_July114"
